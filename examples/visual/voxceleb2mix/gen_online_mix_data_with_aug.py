...
python gen_online_mix_data_with_aug.py \
    --mp4_dir /F00120240032/voxceleb2_zk_mixture/mp4/train \
    --output_dir ./online_mix2_with_aug \
    --num_mixtures 5 \
    ...
    --snr_range -5 10 \
    --noise_prob 0.5 \
    --noise_lmdb_file /maduo/exp/wesep_wenet/datasets/voxceleb2mix/data/musan/lmdb/data.mdb \
    --skip_test
"""
